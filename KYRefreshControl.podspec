Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/cheunghy/KYRefreshControl.git', :tag => "1.0.3", :submodules => true }
  s.requires_arc = true

  s.ios.deployment_target = '6.0'

  s.public_header_files = 'KYRefreshControl/KYRefreshControl.h'
  s.source_files = 'KYRefreshControl/KYRefreshControl.{h,m}'
